...
For the hackathon, ReFleek should focus on simple flat or semi-flat products. These are easier to make from deadstock rolls and reclaimed fabric panels than fitted garments.

This keeps the workflow realistic and production-friendly.

## Category 1: Home Textiles

Home textiles are ideal for deadstock fabric because they often use simple shapes, repeated dimensions, and straightforward finishing.
...
- Reclaimed denim panels
- Deadstock canvas
- Cotton twill
- Mixed shirt cotton panels
...
- Deadstock linen blend
- Cotton voile
- Medium-weight cotton
- Reclaimed large fabric panels
...
- Interior decor
- Gallery / event installation
- Brand storytelling

## Category 2: Accessories

Accessories work well for reclaimed materials because they can use smaller panels and irregular pieces.
...
### Silk Scarf / Lightweight Scarf

Best materials:

- Deadstock silk
- Lightweight deadstock polyester
- Deadstock viscose
- Lightweight reclaimed fabric panels
...
For the MVP, avoid complex fitted garments.
...
- Trousers
- Fitted dresses
- Complex multi-size garments
- Performance wear
- Products requiring advanced pattern grading
